<?PHP
   ...
   //      $merkelappmix =  [6073,6074,6075,6076,6077,6078,6079,6080,6081,6082,6083,6084,6085,6086,6087,6088,6089,6090,6091,6093,6094,6295,6095 ];
   $merkelappmix =  [6092,6096 ];
         ...
         if( count( $readymerkelapps ) ){
            ...
            foreach( $readymerkelapps as $merkelapp ){
               ...
               if( in_array( $merkelapps->articleid, $merkelappmix  )) continue;
               ...
               foreach( $hol as $line ){
                  ...
                  if( $articleid == 7261 || $articleid == 7262 || $articleid == 7700){
                     ...
                     if( $portalid == 'SK-001' ){
                        $imagepath = "/home/produksjon/merkelapp/kuttekanter/malsparelapp2018.jpg";
                     }
                     ...
                     try{
                        ...
                        $draw->setFont( '/var/www/eurofoto/other/fonts/barcode/free3of9.ttf' );
