<?php
   ...
   class StabburetEditor extends WebPage implements IView {
      ...
      public function Thumbface( $id ){
         ...
         $template = new Imagick();
         $template->newImage(200, 240, new ImagickPixel(none));
         $template->setImageFormat('jpeg');
         ...
         $thumb = new Imagick();
         $thumb->readImageBlob($imageBlob);
         $thumb->thumbnailImage( 200, 240 , false );
      ...
      public function Thumbint( $id ){
         ...
         $image = new Imagick();
         $image->newImage(200, 240, new ImagickPixel(none));
         ...
         $img->thumbnailImage( 200, 240 , false );
      ...
      public function StreamThumb( $id ){
         ...
         $filecontent = str_replace( 'data:image/jpeg;base64,', '' , $filecontent );
         //$filecontent = base64_decode( $filecontent );
         $foreground = new Imagick( '/var/www/repix/sites/skanska/webroot/css/mal/preview_tom.png' );
         $image = new Imagick();
         $image->newImage(200, 240, new ImagickPixel('white'));
