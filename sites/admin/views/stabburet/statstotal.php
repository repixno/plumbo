<?PHP
    ...
    import( 'pages.admin' );
      ...
      protected $template = 'stabburet.statstotal';
...
$workbook->send('stabburett-total.xls');
...
$worksheet->write(0, 8, 'Samtykke Orkla');
$worksheet->write(0, 9, 'Samtykke JP');
$worksheet->write(0, 10, '3 parts');
$worksheet->write(0, 11, 'Stats Stabburet');
$worksheet->write(0, 8, 'Samtykke Orkla');
$worksheet->write(0, 9, 'Annonser');
$worksheet->write(0, 10, 'Tilpassninger');
$worksheet->write(0, 11, 'Samtykke Repix');
$worksheet->write(0, 12, 'Registrert  Dato');
...
foreach( $orders as $order ){
	...
	$worksheet->write($i, 8, $order['newsletter_others']);
	$worksheet->write($i, 9, $order['newsletter']);
