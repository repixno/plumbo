...
function CheckAuthentication()
{
	...
	return Login::isLoggedIn() && Login::isAdmin();

}

// LicenseKey : Paste your license key here. If left blank, CKFinder will be
// fully functional, in demo mode.
$config['LicenseName'] = 'Eurofoto AS Development';
$config['LicenseKey'] = '-';
...
*/
$baseUrl = sprintf( '%s/cms/', WebsiteHelper::staticRotatedUrl() );
...
ATTENTION: The trailing slash is required.
*/
$baseDir = sprintf( '%s/data/cms/', getRootPath() );
