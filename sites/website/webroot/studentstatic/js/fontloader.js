(function($) {
	$.fn.fontmenu = function(options){
        ...
        $.post( "/api/2.0/create/fontloader", function( data ) {    
            var i = 0;
            ...
            $.each( data.data, function( key, value ) {
                    ...
                    $.each( value, function( fkey, fvalue ) {
						...
						//if(fkey == 'Regular'){
							$('style').append( '@font-face{ font-family: "' + fontfamily + '"; src: url("/studentstatic/editorfonts/' + fvalue + '"); font-weight: ' + fkey + '; font-style: '+ fkey +' ;}');
