...
class Xml extends WebPage implements IView {
   ...
   public function saveXml(){
      ...
      if($project->user_id == $user){
		 ...
		 try{
			...
			mail( 'tor.inge@eurofoto.no', "Porblem saving thumd mc" , $e->getMessage() );
		 }
   ...
   public function projectXml($id){
      ...
      if($project->user_id == $user){
		 ...
		 if(strrpos($xml_project,"{library}Backgrounds\Xmas\Jul01.jpg") > 1){
			   $xml_project = str_ireplace("{library}Backgrounds\Xmas\Jul01.jpg",	"{library}Backgrounds\Xmas\jul01.jpg",	$xml_project);
         }
