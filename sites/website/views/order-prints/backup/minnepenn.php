<?php
   ...
   class OrderPrintsBackupDVD extends UserPage implements IView {
      ...
      protected $template = 'order-prints.backup.minnepenn';
      
      // Max size for a Minnepenn in Mb
      private $maxmbsize = 7450;
      ...
      public function Execute() {
         ...
         $productoptionid = $settings['MINNEPENN'];
         ...
         $this->unitprice = (int) ProductOption::priceFromProdNo($this->product['options'][0]['prodno'], $this->discquantity);
      ...
      public function addToCart( $productoptionid, $quantity = 1 ) {
         ...
         $dvdtitle = 'Minnepenn ( ' . $totaldiscquantity . 'stk.) ';
