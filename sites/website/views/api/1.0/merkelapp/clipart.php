<?php
   ...
   class ListClipart extends JSONPage implements NoAuthRequired, IView {
         ...
         $images = array();
         $xmlfile = ("/var/www/repix/sites/static/webroot/gfx/merkelapp/$type/$category/category.xml");		               
         ...
         if( file_exists($xmlfile ) ){
            ...
            foreach( glob('/var/www/repix/sites/static/webroot/gfx/merkelapp/'. $type . '/' .$category. '/*.png') as $res){
                        $images[] = basename( $res );
               }
