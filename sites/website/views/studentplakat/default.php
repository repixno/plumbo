<?php
   ...
   class GiftCreator extends WebPage implements IView {
      ...
      protected $template = 'studentskilt.studentplakat';
...
$selected = $image->selected();
      ...
      public function Studentplakat( $productid = 4087, $productoptionid = 4088, $gifttemplateid = 0, $imageid = 0 ) {
         ...
         $this->template = 'studentskilt.studentplakat';
      ...
      public function Komplett( $productid = 4087, $productoptionid = 4088, $gifttemplateid = 0, $imageid = 0 ) {
         
         $this->template = 'studentskilt.komplett';
         
         $this->Execute($productid, $productoptionid  );
           
      }
      
      public function Klassiskt( $productid = 4131, $productoptionid = 4132, $gifttemplateid = 0, $imageid = 0 ){
         
         $this->template = 'studentskilt.klassiskt';
         
         $this->Execute( 4131, 4132, 2964  );
      ...
      public function Banderoll( $productid = 4131, $productoptionid = 4132, $gifttemplateid = 0, $imageid = 0 ){
         ...
         $this->template = 'studentskilt.banderoll';
