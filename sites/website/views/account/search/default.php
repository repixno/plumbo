<?PHP
   ...
   class AccountSearch extends ProtectedPage implements IValidatedView {
      
      protected $template = 'account.search.index';
       ...
       * Result
       *
       * adds string and result to view
       */
      
      public function result() {
         
         $this->setTemplate( 'account.search.result' );
