<?php
   ...
   class AccountSettings extends ProtectedPage implements IView {

      protected $template = 'account.settings.index';
      
      /**
       * Execute
       * 
       * adds statusmsg, user, countries, credits, subscription, discounts to view
       *
       */
         ...
         if( !empty( $user ) && $user instanceof User  ) {
            ...
            $userdata = array(
               ...
               "contactinfo"     => array(
                  ...
                  "countryname"         => $this->getUserCountryName( $user->country ),
               ...
               "gender"             => $user->gender,
               "birthdate"       => $user->born ? date( 'd.m.Y', strtotime( $user->born ) ) : null,
               "avatar"    => array(
      ...
      private function getUserCountryName( $country = 160 ) {
         
         $efCountries = Settings::getSection( 'efcountries' );
         return $efCountries[$country]["name"];
