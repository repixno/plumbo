 ...
 function update() {
    ...
    var color = encodeURIComponent( $('[name="font-color"]').val() );
     ...
     var previewlink = '/api/1.0/merkelapp/preview?projectid=' + projectid + '&line1=' + line1 + '&line2=' + line2 + '&line3=' + line3 + '&font=' + $('input[name="font-type"]:checked').val() + '&gravity=' + gravity + '&image=' + ownimage + '&clipart=' + clipart + '&backgroundfile=' + backgroundfile + '&color=' + color + '&treshold=' + treshhold + '&crop=' + selection + '&colormode=' + colormode;
     ...
     $('.clips').each( function(){
      ...
      $.post('/api/1.0/merkelapp/clipart', {
         ...
         $(response.images).each(function (index, value) {
             THIS.append('<img class="clip"  data-category="'+ category +'" title="' + value + '"src="' + staticroot + 'gfx/merkelapp/' + folder + '/' + category + '/' + value + '" width="100px;" style="margin-right: 5px;"/>');
         })
     }, 'json');
         ...
         var category =  $(this).data('cat');
          ...
          $.post('/api/1.0/merkelapp/backgrounds', {
            backgroundcat: category,
                ...
                $(response.images).each(function (index, value) {
                     //console.log(value);
                  THIS.append('<img class="backgroundfile" data-cat="' + category + '" title="' + value + '"src="' + staticroot + 'gfx/merkelapp/bakgrunner/' + category + '/thumbs/' + value + '" style="width: 150px; margin-right: 1px;"/>');
                })
         }, 'json');
