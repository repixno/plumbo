 function update() {
    ...
    var color = encodeURIComponent( $('input[name="font-color"]').val() );
     ...
     var previewlink = '/api/1.0/merkelapp/preview?projectid=' + projectid + '&line1=' + line1 + '&line2=' + line2  + '&font=' + $('select[name$="font-type"]').val() + '&gravity=' + gravity + '&image='  + '&clipart=' + clipart + '&backgroundfile=' + backgroundfile + '&color=' + color + '&treshold=' + treshhold + '&crop=' + selection + '&colormode=' + colormode;
         ...
         var category =  $(this).data('cat');
          ...
          $.post('/api/1.0/merkelapp/backgrounds', {
            backgroundcat: category,
                ...
                $(response.images).each(function (index, value) {
                     console.log(value);
                  THIS.append('<img class="backgroundfile" data-cat="' + category + '" title="' + value + '"src="' + staticroot + 'gfx/merkelapp/backgroundfiles/' + category + '/thumbs/' + value + '" style="width: 165px; margin-right: 5px; margin-bottom: 5px;"/>');
                })
         }, 'json');
