...
$(document).ready( function() {
   ...
   //$('#contact-email').focus();
	...
	function toggleDeliveryOptionsLoading() {
	   ...
	   $( '#delivery-methods-wrapper' ).append( '<img style="display:block; margin-left:auto; margin-right:auto; margin-top:20px;" src="http://static.repix.no/gfx/gui/ajax-loader.gif" />' );
