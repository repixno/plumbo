 function update() {
    ...
    var color = encodeURIComponent( $('input[name="font-color"]').val() );
     ...
     var previewlink = '/api/1.0/merkelapp/preview?projectid=' + projectid + '&line1=' + line1 + '&line2=' + line2 + '&line3=' + line3 + '&font=' + $('select[name$="font-type"]').val() + '&gravity=' + gravity + '&image='  + '&clipart=' + clipart + '&backgroundfile=' + backgroundfile + '&color=' + color + '&treshold=' + treshhold + '&crop=' + selection + '&colormode=' + colormode;
