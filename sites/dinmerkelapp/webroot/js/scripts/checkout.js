var ajaxLoader = '<img src="http://a.static.eurofoto.no/gfx/gui/ajax-loader.gif" class="loader"/>';
...
$(document).ready( function() {
   ...
   //$('#contact-email').focus();
	...
	function toggleDeliveryOptionsLoading() {
	   ...
	   $( '#delivery-methods-wrapper' ).append( '<img style="display:block; margin-left:auto; margin-right:auto; margin-top:20px;" src="http://a.static.eurofoto.no/gfx/gui/ajax-loader.gif" />' );
	...
	function loadPaymentOptions( inputvalue ) {
	   ...
	   $( '#payment-methods-wrapper' ).empty();
	   $( '#payment-methods-wrapper' ).append( '<img style="display:block; margin-left:auto; margin-right:auto; margin-top: 20px;" src="http://a.static.eurofoto.no/gfx/gui/ajax-loader.gif" />' );
