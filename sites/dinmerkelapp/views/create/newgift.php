<?php
   ...
   class MultipageGiftCreator extends WebPage implements IView {
      
      private $productoptions;
      private $gifttemplates;
      
      protected $template = 'create.newgift';
      ...
      public function Template( $productid = 0, $productoptionid = 0 ){
         
         
         $this->template = 'create.selecttemplate';
                  ...
                  */
                  ...
                  try{
                     if( $page->image->bid == 0 ){
                        ...
                        mail( 'tor.inge@eurofoto.no', "kalenderbug", "userid:" . Login::userid() . "\nPage: \n" . print_r( $page, true ) . "\nBrowser: \n" . print_r($browser, true)  );
                     }
                  }catch( Exception $e ){
                     mail( 'tor.inge@eurofoto.no', "kalenderbug bug", $e->getMessage());
                  }
