   ...
   class CreateImageText extends JSONPage implements NoAuthRequired, IValidatedView {
      ...
      private function writeText( $projectid, $text= '', $gravity='', $font='', $clipart='', $image='', $treshold=2, $crop=0 , $color = "", $backgroundfile = '', $colormode = '') {
            ...
            if( $colormode == 'color' ){
               ...
               $previewtemplate = '/var/www/repix/sites/dinmerkelapp/webroot/gfx/merkelapp/template_merkelapp2.png';
            }
            ...
            if( $colormode == 'mini' ){
               ...
               $previewtemplate = '/var/www/repix/sites/dinmerkelapp/webroot/cms/images/stempel2.png';
            ...
            if( !empty( $backgroundfile ) ){
               $backgroundsrc = '/var/www/repix/sites/dinmerkelapp/webroot/gfx/merkelapp/backgroundfiles/' . $backgroundfile;
               ...
               if( !empty( $image )  || !empty( $clipart ) ){
                     ...
                     if( $colormode != 'color' ){
                        ...
                        if( $colormode != 'color' ){
                         ...
                         $src = '/var/www/repix/sites/dinmerkelapp/webroot/gfx/merkelapp/colorclipart/' . $clipart;
                        }
                     }
