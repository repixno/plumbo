   ...
   class CreateImageText extends JSONPage implements NoAuthRequired, IValidatedView {
      ...
      private function writeText( $projectid, $text= '', $gravity='', $font='', $clipart='', $image='', $treshold=2, $crop=0 , $color = "", $backgroundfile = '', $colormode = '') {
            ...
            if( $colormode == 'color' ){
               ...
               $previewtemplate = '/var/www/repix/sites/dinmerkelapp/webroot/gfx/merkelapp/template_merkelapp4.png';
            }
               ...
               $previewtemplate = '/var/www/repix/sites/dinmerkelapp/webroot/gfx/merkelapp/stempel2.png';
            ...
            if( !empty( $backgroundfile ) ){
               $backgroundsrc = '/var/www/repix/sites/dinmerkelapp/webroot/gfx/merkelapp/bakgrunner/' . $backgroundfile;
               if( file_exists( $backgroundsrc ) ){
                  $background = new Imagick( $backgroundsrc );
                 /* tatt vekk skalering pga bakgrunnane ikkje er kvadratiske lengre.
            ...
            $template->setImageFormat('png');
               ...
               if( !empty( $image )  || !empty( $clipart ) ){
                     ...
                     if( $colormode != 'color' ){
                        ...
                        if( $colormode != 'color' ){
                           $src = '/var/www/repix/sites/dinmerkelapp/webroot/gfx/merkelapp/clipart/' . $clipart;
                        }else{
                         $src = '/var/www/repix/sites/dinmerkelapp/webroot/gfx/merkelapp/motiv/' . $clipart;
                        }
                     }
               ...
               $template->scaleImage( 308, $previewheight );
                // tidligare visning $template->scaleImage( 204, $previewheight );
