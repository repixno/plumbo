<?php
   ...
   class Checkout2Confirm extends WebPage implements IView {
      
      protected $template = 'utsjekk.confirm';
      ...
      public function Execute() {
         ...
         $user = User::fromUsernameAndPortal($email, 'DM-002');
         if( $user ){
             ...
             try {
                 ...
                 $user->save();
                  ...
                  $to = "$email ";
                  $subject = "24 Gratis merkelapper!!";
                  //  $txt .= '<img src="https://gratis.dinmerkelapp.no/velkommen/" alt="Logo DInmerkelapp" />';
           //       $txt = "Hei $email!, Velkommen som kunde";
                   //          $txt = "Hei $email!, Velkommen som kunde.  Bruk kode DMGF24 ved bestilling";
              //   $txt = file_get_contents( "/var/www/repix/sites/dinmerkelapp/templates/gratis/utestemmemail.html" ) ;
    //    $headers .= 'Fra: Gratis merkelapper <post@dinmerkelapp.no>' . "\r\n";
$headers = "MIME-Version: 1.0" . "\r\n";
$headers .= "Content-type: text/html; charset=iso-8859-1" . "\r\n";
$headers .= "From: ordrer@dinmerkelapp.no" . "\r\n";
        
        
                //  $headers .= 'Bcc: adele@skjerdal.net' . "\r\n";
                 // $headers .= 'Cc: adele@skjerdal.net' . "\r\n";
           
                 $htmlContent = ' 
    <html> 
    <head> 
        <title>Velkommen som kunde hos Dinmerkelapp</title> 
    </head> 
    <body style="color=#3A5563">
    <img src="https://static.repix.no/cms/images/gratis_dm (1).jpg" alt="Dinmerkelapp" title="Dinmerkelapp"/>
  
       <h3>Velkommen som kunde hos oss!</h3>
       <h4>Her er link til bestilling av 24 Gratis merkelapper</h4>
       
       <a href="https://merkd.no/bestilling/gratismerkelapp">merkd.no/gratismerkelapp</a>
         <h4>Din kode er: <strong>DMGF24</strong></h4>
         <h4>Koden er personlig og kan kun brukes 1 gang pr kunde/registrerte e-postadresse </h4>
        
        	<a href="https://www.dinmerkelapp.no">
    <img src="https://static.repix.no/cms/images/footer_dm.jpg" alt="Dinmerkelapp" title="Dinmerkelapp"/>
			</a>
    </body> 
    </html>';  
      ...
      private function setAddresses( $info, $cart ) {
         ...
         $delivery["address"] = $info["daddress2"];
         ...
         if( !isset( $contact["firstname"] ) || !isset( $contact["lastname"] ) || !isset( $contact["address"] ) || !isset( $contact["zipcode"] ) || !isset( $contact["city"] ) || !isset( $contact["country"] ) ) {
            ...
            $cart->setContactInfo( $contact, $delivery );
         }
         ...
         if( isset( $info["other-delivery-address"] ) ) {
            ...
            $cart->setDeliveryInfo( $contact, $delivery );
         }
