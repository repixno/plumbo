<?php
   ...
   class Execute extends UserPage implements IView {
      ...
      public function Execute(){
	    ...
	    mail( 'tor.inge@reedfoto.no' , "Checoutinclopete: ",  "feil med klarna"  );
            ...
            try {
               ...
               try{
                  ...
                  mail('tor.inge@reedfoto.no', 'feil med oppdatering av kunde' , $e->getMessage() );
               ...
               if( $orderidresult = $userorder->executeOrder() ){
                  ...
                  relocate( '/klarna_verifiser/finished/' .  $orderidresult );
                  die();
                  
               } else {
                  
                  //Util::Debug("ka farskebn");
                  mail( 'tor.inge@reedfoto.no' , "Klarna order failed ", $message  );
                  relocate( '/checkout/error' );
               ...
               mail( 'tor.inge@reedfoto.no' , "User Order Failed! Creditcard Reason3: ", $message  );
