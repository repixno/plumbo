...
$(document).ready( function() {
	...
	$('input.order-print-quantity').before('<a href="#" class="button changequantity">-</a>').prev().click( function() { 
	...
	$('input.order-print-quantity').after('<a href="#" class="button changequantity">+</a>').next().click( function() { 
