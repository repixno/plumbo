    ...
    Crop.prototype = {
      init: function () {
        ...
        var defaultControls = $('<div/>', { 'class' : 'cropControls' })
              .append($('<button/>', { 'class' : 'openimagebox', 'type':'button', 'text': 'Open' }))
              .append($('<button/>', { 'class' : 'bw', 'type':'button', 'id' : 'bw' }))
              .append($('<button/>', { 'class' : 'rotateLeft', 'type':'button' }))
              .append($('<button/>', { 'class' : 'rotateRight', 'type':'button' }))
        ...
        this.$frame.parent().append(this.options.controls || defaultControls);
        this.updateOptions();
