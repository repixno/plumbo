	...
	$( '#delivery-methods-wrapper :radio' ).click( function() { 
      ...
      $.post( '/api/1.0/checkout/paymentmethods', { 
         ...
         if( data.result ) {
            ...
            var poptions = data.paymentoptions;
            $.each( poptions, function( i, option ) {
               var tmpwrapper = $( '<div class="row" style="border-bottom: 1px dotted #000;"><div class="col-md-10"/></div>' );
               ...
               if( option.refid  == '407' ){
                    tmpwrapper.append( '<div class="col-md-2 last"><img src="http://a.static.repix.no/cms/images/dankort.jpg" /></div>' );
               }
               paymentwrapper.append( tmpwrapper );
