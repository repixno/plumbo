   ...
   function save(){
           ...
           data.template = {
               ...
               'plantype' : 'personalromplan'
           };
           
           

           
            //console.log( $('.gridplaceholder').height() * ratio );
            //console.log( $('.gridplaceholder').width()  * ratio );
            //console.log( $('.gridplaceholder').css('border-color'));
            //console.log( $('.gridplaceholder').position());
           
            /*var headergrid = new Array();
            $('.headergrid table').each( function(index, item ){
   ...
   function setupText() {
       ...
       var dayheight = parseIntUkeplan(malArray.imagefield_y / ratio / 2) - 2;
       
       $('img.day').each(function () {
            
          if( $(this).attr('alt') == 'Navn:'){
           ...
           fontcolor = "000000";
           $(this).attr('src', '/api/1.0/gift/text_ukeplan/?id=0&quality=1&png=1&font=arial&gravity=West&color=' + fontcolor + '&background=' + backgroundcolor + '&text=' + $(this).attr('alt') + '&width=' + dayheight  + '&height=' + daywidth + '&rotate=' + rotate + '&orientation=landscape' + align)
   ...
   function updateTopText( text ){
         ...
         $('.imageplaceholder').html('<img id="cropbox1" class="cropbox" src="' + toptext + '" style="position: relative;" height="'+height+'" imageid="textimage" />');
          var headtext = "PESONALROM:"
         var headertext = "/api/1.0/gift/toptext?text=" + headtext + "&width=" +  (width / 3 )  + "&height=" + ( height / 2 ) + "&color=" + color +  "&background=" + toptextbackgroundcolor + "&font=Century_Gothic.TTF&gravity=left";
         
         $('.toptextplaceholder').html('<img id="cropbox2" class="headertext" src="' + headertext + '" style="position: relative;" height="'+( height / 2 ) +'" imageid="headertext" />'); 
         
         var bottomtext ="/api/1.0/gift/toptext?text=" + 'Husk!' + "&width=" + width + "&height=" + height + "&color=" + color +  "&background=" + toptextbackgroundcolor + "&font=Century_Gothic.TTF&gravity=left";
   ...
   function setupTemplateColor() {
       ...
       $('table.main-content td, table.firstmain td').css({
       ...
       $('.maingrid').each( function( index, item ){
          ...
          console.lo
          if( i < 2 ){
            $(this).find('.main-content td').css( {'border-color': bordercolor} );
            $(this).find('.main-first td').css( {'border-color': bordercolor } );
          }else{
   ...
   function setupTemplate() {
       ...
       var top = (malArray.imagefield_y / ratio);
       ...
       top += parseIntUkeplan(malArray.imagefield_height / ratio);
       $('.toptextplaceholder').css({
           height: parseIntUkeplan(malArray.imagefield_height / ratio / 3) + 'px',
           width: ((malArray.imagefield_x + malArray.imagefield_width) / ratio) + 'px',
           left: (malArray.imagefield_x / ratio) + 'px',
           top: top + 'px'
       });
       
       top += parseIntUkeplan(malArray.imagefield_height / ratio / 2) ;
       
       $('.imageplaceholder').css({
           height: parseIntUkeplan(malArray.imagefield_height / ratio) + 'px'
       });

       var gridwidth = ( malArray.imagefield_width  / ratio ) - 150 ;
       
       $('div.textplaceholder').css({
           top: top + 'px',
           height: ( ( malArray.imagefield_height / 2 )  / ratio) + 'px',
           width: gridwidth + 'px',
           left:  (malArray.imagefield_x / ratio) + 'px',
       });
       ...
       top += parseIntUkeplan(malArray.imagefield_height / ratio / 2) ;
       $('.grid' ).css({
           width: ( ( gridwidth / numberofcolumns ) - 2 ) + 'px',
           height: gridheight + 'px'
       }).height(gridheight);
       

       var mainheight = $('.editorcontainer').height() - top - 50;
       ...
       var firstmain  = ( ( gridwidth /  numberofcolumns ) - image_spaces ) *  1.3 ;
       $('.firstmain').css({
           width:  firstmain +  'px'
       });
       ...
       $('.secondmain').css({
           width: ( ( gridwidth  / numberofcolumns ) * (  numberofcolumns - 1 ) - image_spaces ) + 'px'
       });
       
       
       var mainwidth = ( ( gridwidth ) - firstmain  ) / ( numberofcolumns  - 1 ) - 2;
       $('.main-content').css({
           width: mainwidth + 'px',
           height: ( mainheight / $('.firstmain').size() ) - 2  + 'px',
           'margin-bottom': '0em',
      ...
      $('td.gridspace').css({
       ...
       $('.gridplaceholder').css({
           ...
           top: top + 'px',
           width: ( (malArray.imagefield_x / ratio ) + gridwidth ) + 'px',
       });
       $('.texttable').attr('height', ( malArray.imagefield_height / 2 )  / ratio );


       $('.sidegrid').css({
           left: (malArray.imagefield_x / ratio) + ( (malArray.imagefield_x / ratio ) + gridwidth ) + 'px',
           top: top + 'px',
           width: ( (malArray.imagefield_x / ratio ) + gridwidth ) + 'px',
           height: mainheight
       });
       
       $('.sidegrid table').css({height: mainheight});
       ...
       $('.bottomgrid').css({
           height: parseIntUkeplan(malArray.imagefield_height / ratio) * 2 + 'px',
           width: parseIntUkeplan( gridwidth ) + 'px',
       });
   }
   ...
   $(document).ready(function () {
       ...
       $('div.editorcontainer').css( "background-image", "url('http://c.static.repix.no/images/gifttemplates/thumbs/width/700/" + templatefile + "')" );
