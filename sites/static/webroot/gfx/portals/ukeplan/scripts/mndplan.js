   ...
   function setupText() {
       ...
       $('div.day img').each(function () {
           $(this).attr('src', '/api/1.0/gift/text_ukeplan/?id=0&quality=1&png=1&font=arial&gravity=West&color=' + fontcolor + '&background=' + backgroundcolor + '&text=' + $(this).attr('alt') + '&width=' + ($('.grid').height() / 7) + '&height=' + (malArray.imagefield_x / ratio))
   ...
   function newColumn(imageonly) {
       ...
       if (imagelayout == 'each') {
           ...
           imageholderwidth = ( malArray.imagefield_width / ratio / holdercount ) - image_spaces;
       } else{
           holdercount++;
       ...
       $('.cropbox').live('click', function () {
          ...
          if(imagelayout == 'text'){
            ...
            $(this).parent().parent().parent().append('<div class="center edittoptext" " style="width: ' + boxwidth + 'px">' +skrivnytekst+ '<br/>\
                                                      <textarea id="toptext" style="width:300px; height:30px;text-align:center;" wrap="off">' + value + '</textarea><br/>\
