   ...
   function setupText() {
       ...
       $('img.day').each(function () {
           $(this).attr('src', '/api/1.0/gift/text_ukeplan/?id=0&quality=1&png=1&font=arial&gravity=West&color=' + fontcolor + '&background=' + backgroundcolor + '&text=' + $(this).attr('alt') + '&width=' + daywidth + '&height=' + dayheight + '&rotate=' + rotate)
   ...
   $(document).ready(function () {
       ...
       $('#order_ukeplan').live('submit', function () {
        var dialog_buttons = {}; 
        dialog_buttons[accepttxt] = function(){ save();; }
        dialog_buttons[canceltxt] = function(){ $(this).dialog('close'); }
