...
class MediaclipProject extends WebPage implements IView{
	...
	public function edit( $id, $art_type=0, $template=0 ){
		...
		$mediaclip_server = Settings::Get( 'mediaclip', 'server', 'bente.repix.no' );
		...
		*/
		...
		if( strlen( $project->project_xml ) <  4 ){
		      $skipproductArray = array( 3035,3036,3037,3038,7010,7011,7015,8001,8002,7456,969,968, 7116,7115, 7113,939,940, 7105, 7233, 7237, 7238, 7239, 7240 , 7241, 8071, 8072, 8073, 8074, 8075, 8076, 8077, 8078, 7234, 7274, 7275, 7309, 7317, 7318, 7319, 7346,7035,7031,7032,7033,7036, 7037,7034,980,981,982,983,984,985,986,7446,7244,909  );
		...
		//if( $detect->isMobile() || $detect->isTablet() || $_GET['html5'] !== null  || 1 == 1){
			...
			$flasharray = array( 7310, 7035,7031, 7032, 7033,7036, 7037, 7034, 980, 981, 982, 983, 984, 985,986  );
