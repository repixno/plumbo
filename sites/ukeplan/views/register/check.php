<?php
   ...
   class RegisterCheck extends WebPage implements IValidatedView {
      ...
      public function Newsletter(){
         ...
         if( strpos( $email, 'yahoo') > 0 ){
            
            $this->template = "dialogs.yahooerror";
            ...
            if( Dispatcher::getPortal() == 'UP-DK' ){
               ...
               $subject = "Velkommen til Ugeplan.dks hverdagsunivers";
               $fields = array( 'name' => $userinfo['firstname'] );
               
               MailSend::Simple( $userinfo['email'], $subject, 'newsletter.thanks', $fields, 'phptal', 'Ugeplan<kontakt@ugeplan.dk>' );
      
               mail( 'kontakt@ugeplan.dk', 'Ny Ugeplan bruker', print_r( $userinfo , true ) );
            }
