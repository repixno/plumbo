<?PHP
   ...
   class OrderprintsAccessories extends Webpage implements IView {
      ...
      public function Execute() {
         ...
         if( Dispatcher::getPortal() == 'FC-001') relocate( "/cart" );
         ...
         //$accessories = array( 3971, 3050, 3048 ,3056, 2829, 2823, 2831, 2819, 2821 );
       //  $accessories = array( 4261,4263,3177, 3352, 3354, 4096, 4101, 4098, 4103,3971, 3050, 3048 ,3056, 2829, 2823, 2831, 2819 );
       
       // tatt ut 16.05 :2829, 2819 tatt vekk 5309 som er kjempetilbehørspakke
        $accessories = array(   4261,4263,4708, 4364, 5422,5420, 4635, 4637,4639,4641,5418,5416,5310,3177, 3050, 4103,4738,3048, 4096,2831, 3056, 4098, 4101  );
         foreach ($accessories as $productid  ){
            $product = new Product( $productid );
            $associatedproducts[$productid] = $product->asArray();
         }
