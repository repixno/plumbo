			...
			return this.each(function()
			{
				var magnifier = 
				{
					...
					setSensor:function()
					{
						...
						if (magnifier.options.showdialog)
						{
						   magnifier.$sensor.dblclick(function(e){ 
						      $('#' + magnifier.options.showdialogid).show();
						      
						      var w = $('#' + magnifier.options.showdialogid).width() / 2;
						      var h = $('#' + magnifier.options.showdialogid).height() / 2;
						      
						      $('#' + magnifier.options.showdialogid).offset({left: (e.pageX - w), top: (e.pageY - h)});
						      $('#' + magnifier.options.showdialogid).focus();
					...
					setLoader:function()
					{
						magnifier.$loader = $("<div id='dio-loader'></div>").css({width: magnifier.options.lensWidth, height: magnifier.options.lensHeight});
