            ...
            try{
               if($image->hashcodeaaa && file_exists($cachefilename)){
                  ...
                  if( $image->licensefee > 0 || in_array( $image['owner_uid'],  $this->projectowners ) ){
                     ...
                     $watermark->thumbnailImage( (int)  $thumb->getImageWidth()  / 4 , $thumb->getImageHeight()   / 4 , true );
                     $wx = ( $thumb->getImageWidth() -  $watermark->getImageWidth()  );
                     $wy = ( $thumb->getImageHeight() -  $watermark->getImageHeight() );
