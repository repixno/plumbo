<?PHP
   ...
   class OrderprintsAccessories extends Webpage implements IView {
      ...
      public function Execute() {
         ...
         if( Dispatcher::getPortal() == 'FC-001' || Dispatcher::getPortal() == 'MY-KID' || Dispatcher::getPortal() == 'FOTONO' || Dispatcher::getPortal() == 'FOTO-NO' || Dispatcher::getPortal() == 'FOTOPIX' ) relocate( "/cart" );
