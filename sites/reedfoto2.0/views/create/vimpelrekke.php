<?php
   ...
   class GiftVimpelCreator extends UserPage implements IView {
      
      private $productoptions;
      private $gifttemplates;
      
      protected $template = 'create.vimpelrekke';
         ...
         $webcoords = isset( $_POST['web'] ) ? true : false;
		   ...
		   if( count( $editorObject ) > 0 ) {
              ...
              try{
                  ...
                  $font = (string)$editorObject[0]->font ? (string)$editorObject[0]->font  :'Source Sans Pro';
                  $fontcolor = (string)$editorObject[0]->fontcolor;
              }catch( Exception $e ){
                  //do nothing
              }
