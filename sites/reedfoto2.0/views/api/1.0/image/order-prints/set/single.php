<?php
   ...
   /**
    * Set the quantity for a product on a single image in order process
    * 
   ...
   class APIImagesProductQuantity extends JSONPage implements IValidatedView{
       ...
       * Set the quantity for a product on a single image in order process
       * 
       * @api-name image.order-prints.set.single
       * @api-auth required
       ...
       */  
      public function Execute( $prodno, $imageid, $quantity ) {
