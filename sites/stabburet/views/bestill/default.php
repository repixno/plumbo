<?php
   ...
   class StabburetEditor extends WebPage implements IView {
      ...
      public function Thumbmob( $id ){
         ...
         $foreground = new Imagick( '/var/www/repix/sites/website/stabburet/stabburetstatic/mal/thumbmaskmobil.png' );
      ...
      public function StreamThumb( $id ){
         ...
         $filecontent = str_replace( 'data:image/jpeg;base64,', '' , $filecontent );
         //$filecontent = base64_decode( $filecontent );
         $foreground = new Imagick( '/var/www/repix/sites/stabburet/webroot/stabburetstatic/mal/Leverpostei_bestill_2019.png' );
         $image = new Imagick();
