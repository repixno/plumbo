   ...
   class CheckoutConfirm extends WebPage implements IView {
      ...
      public function Execute() {
        ...
        //$newsletter=nyhetsbrev Repix
         ...
         $user = User::fromUsernameAndPortal($email, 'ST-001');
         ...
         if( $user->newsletter_repix == true ){
            $this->coupon( 'REPIX2019' );
            $cart = new Cart();
            $cart->recalculateTotals();
         }
         else{      
        ...
        //    $paymentmethod = 1;
         //   $deliverymethod = 1;
           ...
           // For å lese array for kundedata
      ...
      public function coupon($discountCode) {
