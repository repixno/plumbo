<?php
   ...
   class ManualOrder{
      ...
      public function executeManualOrder( $data ) {
         ...
         /*for å få inn porto fra xml*/$this->delivery = $data['delivery'];
         
       /*for å få inn grunnbeløp fra xml*/  $this->startprice = $data['startprice'];
      ...
      private function OrderItems(){
         ...
         /*setter inn pris på levering fra xml*/            
	 ...
	 $dinfo = $this->data;
      ...
      private function insertOrder() {
         ...
         else if( $this->kampanje == 'FOTO-NO' ){
            $kampanje_kode = 'FOTO-NO';
         }else{
      ...
      private function insertShippingCost() {
         ...
         if($shippingcost > 0){
            ...
            $orderrow->text         = ' Porto og Eksp / Grunnavgift';
            $orderrow->save();
         }
         }catch ( Exception $e){
